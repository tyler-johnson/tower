...
//! spawns constant in flight count, [`probe`]
...
//! record of how often a flight changed hands. [`doctor`] is the
//! health fold — the seam's own answer and the events off the board as
//! rows over the fold, and it observes and complains, never enforces. [`resolve`] is how a typed
