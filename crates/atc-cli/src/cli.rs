...
pub enum Command {
    ...
    Next {
        ...
        /// Unsaid: your own queue, your client's lane, the pool, and the
        /// unassigned lane; a person's own queue and the unassigned lane.
        #[arg(value_name = "lane")]
        lanes: Vec<String>,
    ...
    Hook {
        /// The clients to wire — claude, codex, cursor, qwen, opencode, copilot — or the
    ...
    Unhook {
        /// The clients to unwire — claude, codex, cursor, qwen, opencode, copilot — or the
        /// shells: bash, zsh, fish, powershell.
        #[arg(value_name = "client")]
        slugs: Vec<String>,
    ...
    Trigger {
        /// The source whose hook is running this — claude, codex, cursor, qwen, copilot,
