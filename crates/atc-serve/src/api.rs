...
use atc_core::board::{self, Query, ResolveError};
use atc_core::log::{self, Store};
use atc_core::machine;
use atc_core::{procedure, verb};
use axum::Router;
use axum::body::Bytes;
...
mod tests {
    ...
    fn the_status_table_maps_contention_conflict_and_bad_body() {
        ...
        assert_eq!(on_the_url.exits(), vec!["atc".to_string()]);
    }
}
